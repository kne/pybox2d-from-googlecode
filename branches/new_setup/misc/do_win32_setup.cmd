REM This script creates release installers for the supported versions of Python
REM in Windows. Though it's a windows command script, it does uses some stuff
REM from MSYS (cat/mv/rm/etc)
