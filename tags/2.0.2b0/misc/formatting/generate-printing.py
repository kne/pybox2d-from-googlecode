...
def evaluate(name):
    ...
    if len(value_strings) == 0:
        ...
        return '"%s(%s)" %% (%s)' % (name, " ".join(prop_strings), value_strings[0])
    else:
